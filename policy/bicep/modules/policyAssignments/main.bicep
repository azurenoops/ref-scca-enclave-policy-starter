...
module policyAssignment_mg './managementGroup/az.auth.policy.set.assignment.mg.bicep' = if (empty(subscriptionId) && empty(resourceGroupName)) {
...
module policyAssignment_sub './subscription/az.auth.policy.set.assignment.sub.bicep' = if (!empty(subscriptionId) && empty(resourceGroupName)) {
...
module policyAssignment_rg './resourceGroup/az.auth.policy.set.assignment.rg.bicep' = if (!empty(resourceGroupName) && !empty(subscriptionId)) {

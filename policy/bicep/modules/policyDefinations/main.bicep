...
module policyDefinition_mg './managementGroup/az.auth.policy.def.mg.bicep' = if (empty(subscriptionId)) {
...
module policyDefinition_sub './subscription/az.auth.policy.def.sub.bicep' = if (!empty(subscriptionId)) {

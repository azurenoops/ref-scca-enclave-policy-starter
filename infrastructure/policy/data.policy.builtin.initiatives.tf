...
data "azurerm_policy_set_definition" "deploy_configure_microsoft_defender_for_cloud_plans_initiative" {
  name = "f08c57cd-dbd6-49a4-a85e-9ae77ac959b0" #"Configure Microsoft Defender for Cloud plans"
}
...
data "azurerm_policy_set_definition" "deploy_enable_audit_category_group_resource_logging_for_supported_resources_to_Log_Analytics_initiative" {
  name = "f5b29bc4-feca-4cc6-a58a-772dd5e290a5" #"Enable audit category group resource logging for supported resources to Log Analytics"
}
